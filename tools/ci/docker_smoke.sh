...
# Substitute: minecraft, coworld-minecraft, 1.
#
...
#
# env:
#   SMOKE_IMAGE                image, if not given as $1        (coworld-minecraft:ci)
#   SMOKE_SLUG                 game slug                        (minecraft)
#   SMOKE_GAME_BIN             game entrypoint                  (/bin/minecraft)
#   SMOKE_PLAYER_BIN           player entrypoint                (/bin/minecraft-player)
...
image="${1:-${SMOKE_IMAGE:-coworld-minecraft:ci}}"
slug="${SMOKE_SLUG:-minecraft}"
